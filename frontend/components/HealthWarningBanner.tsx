...
export default function HealthWarningBanner({ message, variant = 'error', linkHref, linkText }: HealthWarningBannerProps) {
  ...
  return (
    <div
      className={
        isInfo
          ? 'relative z-30 flex-shrink-0 bg-sky-50 dark:bg-sky-900/80 border-b border-sky-200 dark:border-sky-700 px-4 py-2 shadow-sm'
          : 'relative z-30 flex-shrink-0 bg-amber-50 dark:bg-amber-900/80 border-b border-amber-200 dark:border-amber-700 px-4 py-2 shadow-sm'
      }
    >
